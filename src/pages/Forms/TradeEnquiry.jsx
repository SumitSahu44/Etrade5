...
import { Send, Globe, Phone, Building2 } from 'lucide-react';
...
const TradeEnquiry = () => {
  ...
  const labelClass = "block text-[10px] font-black text-blue-900 uppercase tracking-[0.2em] mb-2 ml-1";
          ...
          <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-blue-100 pb-8">
            <div>
              <div className="flex items-center gap-2 text-blue-600 mb-3">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.3em]">Global Sourcing</span>
              </div>
            ...
            <p className="text-slate-500 font-medium text-sm max-w-[240px]">
              Our specialized trade desk will process your request within 24 hours.
            </p>
          </div>
          ...
          <form className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="relative">
                ...
                <div className="relative">
                  <input type="text" className={inputClass} placeholder="Contact Name" />
                </div>
              </div>
              <div>
                <label className={labelClass}>Enterprise Name</label>
                <div className="relative">
                  <input type="text" className={inputClass} placeholder="Company Ltd." />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <label className={labelClass}>Direct Communication</label>
                <div className="relative">
                  <input type="tel" className={inputClass} placeholder="Mobile / WhatsApp" />
              ...
              <div>
                ...
                <select className={inputClass}>
                  ...
                  <option>Certified Spares</option>
                </select>
              </div>
            </div>

            <div>
              <label className={labelClass}>Procurement Specs</label>
              <textarea 
                className={`${inputClass} h-40 resize-none pt-4`} 
                placeholder="Mention Grade, Gsm, Quantity, and Timeline..."
              ></textarea>
            </div>
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-6 bg-blue-600 text-white rounded-[2rem] font-black text-xs uppercase tracking-[0.3em] shadow-2xl shadow-blue-200 hover:bg-blue-700 transition-all flex items-center justify-center gap-3"
            >
              Dispatch Enquiry <Send size={18} />
            </motion.button>

            <div className="text-center pt-4">
              <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">
                Official Submission Portal • Parekh e-Trade Market (Textile)
              </p>
            </div>
          </form>
        </div>
